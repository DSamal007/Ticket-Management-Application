...
router.delete('/departments/:id',aunthenticateUser, departmentsController.delete)
...
router.delete('/tickets/soft_delete/:id',aunthenticateUser, ticketsController.softDelete)
